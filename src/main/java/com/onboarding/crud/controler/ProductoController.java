package com.onboarding.crud.controler;

import com.onboarding.abstractfactory.services.impls.SqlDatabaseServiceImpl;
import com.onboarding.crud.dto.Mensaje;
import com.onboarding.crud.dto.ProductoDto;
...
public class ProductoController {
    @Autowired
    SqlDatabaseServiceImpl productoService;
@GetMapping("/lista")
    ...
    public  ResponseEntity<?> create (@RequestBody ProductoDto productoDto){
       ...
       productoService.save(producto);
        return new ResponseEntity(new Mensaje("Producto creado satisfactoriamente"),HttpStatus.OK);
    }
